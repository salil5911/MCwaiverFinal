...
export default function AdminPurchaseWaivers() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen">
        <div className="text-center">
          ...
          <p className="mt-4 text-gray-600">Loading purchase waivers...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <AdminLayout>
      <div className="p-6">
        <h1 className="text-2xl font-bold mb-6">Purchase Waivers</h1>
